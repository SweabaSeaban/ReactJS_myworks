  ...
  return (
    <div className="p-3" style={{
      ...
      <div className='md:h-20 md:w-auto flex flex-col md:flex-row items-center relative z-20 flex-wrap'>
        <a href="#home"><img className='h-8 md:h-12' src="\logo.png" alt="Logo" /></a>

        <div className="hidden ml-auto md:flex md:flex-row items-center space-y-2 md:space-y-0 md:space-x-1 ">
